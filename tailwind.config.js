...
module.exports = {
  ...
  variants: {
    ...
    backgroundColor: ['responsive', 'active', 'dark', 'group-hover', 'focus-within', 'hover', 'focus'],
    ...
    cursor: ['responsive'],
    display: ['responsive'],
    divideColor: ['responsive', 'group-hover', 'dark', 'active'],
    ...
    fontVariantNumeric: ['responsive', 'dark', 'hover', 'focus', 'active'],
    ...
    position: ['responsive'],
    resize: ['responsive'],
    ringColor: ['responsive', 'dark', 'active', 'focus-within', 'focus'],
